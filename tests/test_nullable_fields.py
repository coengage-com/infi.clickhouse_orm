...
from infi.coengage_clickhouse_orm.utils import comma_join
    ...
    def _insert_sample_data(self):
        ...
        self.database.insert(
            [
                ...
                ModelWithNullable(
                    date_field="2016-08-30", null_str="nothing", null_int=None, null_date=None
                ),
                ModelWithNullable(
                    date_field="2016-08-31", null_str=None, null_int=42, null_date=dt
                ),
                ModelWithNullable(
