...
from .utils import escape, import_submodules, parse_tsv
...
class Database(object):
    ...
    def __init__(
        ...
        self.server_timezone = (
            self._get_server_timezone() if self.server_version > (1, 1, 53981) else pytz.utc
        )
    ...
    def paginate(
        self, model_class, order_by, page_num=1, page_size=100, conditions=None, settings=None
    ):
        """
